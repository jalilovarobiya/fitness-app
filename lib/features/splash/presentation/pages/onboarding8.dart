...
import 'package:fitness_app/features/splash/presentation/pages/onboarding9.dart';
...
class Onboarding8 extends StatelessWidget {
  ...
  final int totalPage;
  const Onboarding8({super.key, this.currenIndex = 6, this.totalPage = 8});
              ...
              child: DecoratedBox(
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage(AppImages.onboarding7),
                  ),
                ),
              ),
            ),
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        "Follow our Instagram account to keep up with the latest news",
